...
public class Notification {
    ...
    */
     ...
     * @param theme 
     */
    public static boolean SOLO_UNO = false;
    ...
    public static void show(String title, String message, ImageIcon imageFile, int timeOut, Dimension imageSize, boolean soloUno){
        init_server();
        Notification.SOLO_UNO = soloUno;
        event = new NiconEvent(title, message, Notification.DEFAULT_MESSAGE);
        notify = new DesktopNotify(event, imageFile, imageSize);
        serverOSD.send(notify, timeOut);
    }
